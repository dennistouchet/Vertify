...
Meteor.tools = {
  ...
  *******************************************/
  ...
  cancelTask : function(ws_id, t_id, status, msg){
    check(ws_id, String);
    check(t_id, String);
    check(status, String);
    check(msg, String);
  ...
  *******************************************/
  ...
  userConfigEdit : function(userId, config){
    check(config, Object);
    console.log("user edit config entered");
    console.log("type of userId: ", typeof userId);

    var user = Meteor.users.find(userId);

    console.log("config: ", config);
    UserConfigurationSchema.validate(config);

    //Meteor.users.update(userId, { $set: {"config.workspace": config.workspace, "config.route": }});
  },
