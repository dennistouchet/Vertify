...
Meteor.tools = {
  ...
  *******************************************/
  getExternalObjects : function(ws_id, conn_id){
    ...
    /*
    var system = Systems.findOne({"id": sys_id});
    if(system){
      sys_id = system.connector_id;
    }
    console.log(system);*/
    //TODO: verify why this uses sys_id - rename var to connid?
    var extobj = null;
  ...
  getExternalObjectProperties: function(ws_id, sys_id){
    ...
    var properties = null;
    var system = Systems.findOne({"workspace_id": ws_id, "id": sys_id});
    if(system){
